            ...
            <div class="row">
                <div class="col-xs-7">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Conference Room Details</li>
                    </ol>
                </div>
                <div class="col-xs-5">
                    <a href="{{ 'rooms.index' }}" class="link">book a conference room</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 info-frame">
                    ...
                    <div class="btn-holder">
                        <strong class="rent-price">R {{ $room->room_price }} <span>per day</span></strong>
                    </div>
                    <p>
                ...
                <div class="col-sm-12 info-frame @if(!$errors->any()) collapse @endif" id="collapseExample">

                    <form role="form" method="POST" action="{{ route('conference_rooms.store') }}" class="contact-form require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                        @csrf
                       ...
                       <div class="">
                            ...
                            <input type="hidden" name="amount" value="{{ $room->room_price }}">
        ...
        <section class="gallery-block container b-padding">
            <div class="row">
                <header class="col-xs-12">
                    <h1>Conference room gallery pictures</h1>
                </header>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="carousel-example-generic" class="carousel image-gallery slide" data-ride="carousel"> 
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <a href="{{ Voyager::image( $room->room_image_1 ) }}" class="fancybox" ><img src="{{ Voyager::image( $room->room_image_1 ) }}" alt="image description"></a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="{{ Voyager::image( $room->room_image_2 ) }}" class="fancybox" ><img src="{{ Voyager::image( $room->room_image_2 ) }}" alt="image description"></a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="{{ Voyager::image( $room->room_image_3 ) }}" class="fancybox" ><img src="{{ Voyager::image( $room->room_image_3 ) }}" alt="image description"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <a href="{{ Voyager::image( $room->room_image_4 ) }}" class="fancybox" ><img src="{{ Voyager::image( $room->room_image_4 ) }}" alt="image description"></a>
                                    </div>
                                    <div class="col-xs-4">
                                      <a href="{{ Voyager::image( $room->room_image_2 ) }}" class="fancybox"><img src="{{ Voyager::image( $room->room_image_2 ) }}" alt="image description"></a>
                                    </div>
